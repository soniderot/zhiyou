						...
						<div id="ci_module_list" class="mbl">
							<ul id="ci_modules_visible" class="uiList">
														...
														<table class="uiInfoTable noBorder">
															<tbody>
																...
																<tr class="ci_password_row dataRow">
																	<th class="label">
																		<label for="ua7fzy_11_ci_password">
																			电子邮箱密码：
																		</label>
																	</th>
																	<td class="data">
																	...
																	<td class="data">
																		<div>
																			<label for="ua7fzy_12"
																				...
																				<input type="submit" id="ua7fzy_12" onclick=""
																					value="搜索朋友" />
																			</label>
									...
									<div class="ci_module_content hidden_elem">
										<div class="contact_importer_widget ci_webmail">
											<div class="api" id="ua7fzy_13_ci_webmail">
												<div class="clearfix">
													<form
														onsubmit="return function(event){return wait_for_load(this, event, function() {JSCC.get('j4eca1bb8cf8e935727335255').onSubmit(); return false;});}.call(this,event)!==false &amp;&amp; Event.__inlineSubmit(this,event)"
														id="ua7fzy_13_ci_form" name="ua7fzy_13_ci_form"
														method="post"
														...
														<table class="uiInfoTable noBorder">
															<tbody>
																...
																<tr class="ci_password_row hidden_elem dataRow">
																	<th class="label">
																		<label for="ua7fzy_13_ci_password">
																			电子邮箱密码：
																		</label>
																	</th>
																	<td class="data">
																	<s:password name="emailPass" cssClass="inputtext ci_password"  />
																...
																<tr>
																	...
																	<td class="data">
																		<div>
																			<label for="ua7fzy_14"
																				class="uiButton uiButtonConfirm">
																				<input type="submit" id="ua7fzy_14" onclick=""
																					value="搜索朋友" />
																			</label>
																			<img height="11" width="16" alt=""
																				src="http://static.ak.fbcdn.net/rsrc.php/v1/yb/r/GsNJNwuI-UM.gif"
								...
								<li id="ua7fzy_6"
									class="pvs ci_module uiListItem uiListMedium uiListVerticalItemBorder">
									<div
										onclick="JSCC.get(&#39;j4eca1bb8cf8e935727335251&#39;).handleClick(&quot;ua7fzy_6&quot;); return false"
										class="UIImageBlock clearfix">
										<i
											class="UIImageBlock_Image UIImageBlock_MED_Image img sp_apfmrz sx_da3c35"></i>
										<a href="#" class="expand_link UIImageBlock_Ext">搜寻朋友</a>
										<div
											class="ci_module_header UIImageBlock_Content UIImageBlock_MED_Content fwb">
									...
									<div class="ci_module_content hidden_elem">
										<div class="contact_importer_widget ci_webmail">
											<div class="valid" id="ua7fzy_19_ci_webmail">
												<div class="clearfix">
													<form
														onsubmit="return function(event){return wait_for_load(this, event, function() {JSCC.get('j4eca1bb8cf8e935727335258').onSubmit(); return false;});}.call(this,event)!==false &amp;&amp; Event.__inlineSubmit(this,event)"
														id="ua7fzy_19_ci_form" name="ua7fzy_19_ci_form"
														method="post"
														action="https://www.facebook.com/find-friends/index.php"
														class="ci_form">
														<input type="hidden"
														...
														<table class="uiInfoTable noBorder">
															<tbody>
																<tr class="dataRow">
																	<th class="label">
																		<label for="ua7fzy_19_ci_login">
																			你的电子邮件：
																		</label>
																	</th>
																	<td class="data">
																		<input type="text" autocomplete="off"
																			id="ua7fzy_19_ci_login" name="login_str"
																			value="mk-k@163.com" class="inputtext ci_login" />
																	</td>
																</tr>
																<tr class="ci_password_row dataRow">
																	<th class="label">
																		<label for="ua7fzy_19_ci_password">
																			电子邮箱密码：
																		</label>
																	</th>
																	<td class="data">
																		<input type="password" autocomplete="off"
																			id="ua7fzy_19_ci_password" name="password" value=""
																...
																<tr>
																	...
																	<td class="data">
																		<div>
																			<label for="ua7fzy_20"
																				class="uiButton uiButtonConfirm">
																				<input type="submit" id="ua7fzy_20" onclick=""
																					value="搜索朋友" />
																			</label>
																			<img height="11" width="16" alt=""
																				src="http://static.ak.fbcdn.net/rsrc.php/v1/yb/r/GsNJNwuI-UM.gif"
