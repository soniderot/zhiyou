                    ...
                    <div id="listsNav" class="homeSideNav">
                      ...
                      <ul data-gt='{"nav_items_count":"2","nav_section":"listsNav"}' role="navigation" class="uiSideNav mts mbm nonDroppableNav">
                        <li id="navItem_fl_2634661952657" class="sideNavItem stat_elem <s:property value="#session.menuSelect[5]"/>">
                          ...
                          <a data-gt='{"bmid":"2634661952657","count":"0","coeff2_info":"AatJTHR-AJBfw_7yYaQBE-KE2v9rqUbgBsHedfV-KC2Bk0X7wv-hNwMz3WjaR69RBf5WbHX1nfAy8n4IPApXVzpr","coeff2_registry_key":"0016","coeff2_action":"3","rank":"1"}' title="" href="event/event!getEvents.jhtml" class="item clearfix sortableItem">
                            <div class="rfloat">
                              <img height="11" width="16" alt="" src="images/GsNJNwuI-UM.gif" class="uiLoadingIndicatorAsync img"/>
                              <span class="count hidden_elem uiSideNavCount">
                                <span class="countValue fss">0</span>
                      ...
                      <ul data-gt='{"nav_items_count":"5","nav_section":"appsNav"}' role="navigation" class="uiSideNav mts mbm nonDroppableNav">
                       ...
                       <li id="navItem_app_10150110253435258" class="sideNavItem stat_elem <s:property value="#session.menuSelect[7]"/>">
                        ...
                        <li id="navItem_app_2305272732" class="sideNavItem stat_elem <s:property value="#session.menuSelect[8]"/>">
                          ...
                          <a data-gt='{"bmid":"2305272732","count":"0","coeff2_info":"AavlFDtX3Zh1sRcSv6cXUkzN2msD6OSwuDo1LJvCn9BD5qZIaApSrOUUBaHXCVG5Em0","coeff2_registry_key":"0016","coeff2_action":"3","rank":"1"}' title="" href="usr/feed.jhtml?handle=sns.publish.photo,sns.event.photo" class="item clearfix sortableItem">
                            <div class="rfloat">
                              <img height="11" width="16" alt="" src="images/GsNJNwuI-UM.gif" class="uiLoadingIndicatorAsync img"/>
                              <span class="count hidden_elem uiSideNavCount">
                                <span class="countValue fss">0</span>
