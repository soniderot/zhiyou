              ...
              <div class="uiSelectorMenuWrapper  uiToggleFlyout">
                <div class="uiMenu uiSelectorMenu" role="menu">
                  <ul class="uiMenuInner">
                    ...
                    <li data-label="提问"
                      class="uiMenuItem  uiMenuItemRadio  uiSelectorOption">
                      <a href="/?sk=app_10150110253435258"
                        aria-checked="false" tabindex="-1"
                        role="menuitemradio" class="itemAnchor"> <span
                        class="itemLabel fsm"> <i
                          class="mrs  img  sp_cnv1wq  sx_589bc0"></i>提问
                      </span> </a>
                    </li>
                    <li class="uiMenuSeparator"></li>
                    <li data-label="编辑显示设置" class="uiMenuItem">
                      <a
                        ajaxify="/ajax/feed/edit_options_dialog.php?filter_key=lf"
                        rel="dialog-post" href="#" tabindex="-1"
                        role="menuitem" class="itemAnchor"> <span
                        class="itemLabel fsm"><i
                          class="mrs  img  sp_7gl7wd  sx_d43f0c"></i>编辑显示设置</span>
                      </a>
                    </li>
                  </ul>
                </div>
    ...
    <div id="u3mxyl_2"
      ...
      <div class="focus_target">
          ...
          <ul
            ...
            <li
              ...
              <span
                ...
                class="uiIconText selected"> <i
                  class="img sp_7gl7wd sx_bd619c"></i> <strong
                  class="attachmentName">更新信息<i class="nub"></i>
                </strong> </span> </span>
            </li>
            <li class="plm uiListItem uiListHorizontalItemBorder uiListHorizontalItem">
              <span data-endpoint="/ajax/metacomposer/attachment/photo/photo.php" id="u3mxyl_4" class="uiComposerAttachment photoAttachment">
               <a href="#" tabindex="0" class="uiIconText attachmentLink normal">
        ...
        <div class="showWhenOpen mutableContent uiComposerMetaContainer">
          <s:form onsubmit="return updateStatus(this)" method="post" action="/" rel="async">
              ...
              <div class="showOnceInteracted uiMetaComposerMessageBoxShelf">
                <div class="clearfix uiComposerMessageBoxControls">
                  <ul class="uiList uiListHorizontal clearfix uiComposerBarRightArea rfloat">
                    <li data-gt='{"composer":{"comp":"audience","ua_id":"composer:post"}}' id="composerTourAudience" class="privacyWidget uiListItem uiListHorizontalItemBorder uiListHorizontalItem">
                      <div data-referrer="pagelet_privacy_widget" id="pagelet_privacy_widget">
                        <div class="composerAudienceWrapper stat_elem widget">
                          <div data-name="audience[0][value]" class="uiSelector inlineBlock audienceSelector composerAudienceSelector audienceSelectorNoTruncate dynamicIconSelector uiSelectorRight uiSelectorNormal uiSelectorDynamicLabel uiSelectorDynamicTooltip">
                            <div class="wrap">
                              <a rel="toggle" data-length="30"
                                aria-haspopup="1" href="#" role="button"
                                ...
                                class="uiTooltipWrap top right righttop">
                                  <span class="uiTooltipText">你的朋友们</span>
                              </span> </a>
                              <div
                                class="uiSelectorMenuWrapper uiToggleFlyout">
                                  ...
                                  <ul class="uiMenuInner">
                                    <li data-label="公开"
                                      ...
                                      <a
                                        ...
                                        tabindex="0"
                                        role="menuitemradio"
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_701c4a"></i>
                                        <span class="itemLabel fsm">公开</span>
                                      </a>
                                    </li>
                                    <li id="u3mxyl_24" data-label="朋友"
                                      ...
                                      <a
                                        ...
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_dd5a6e"></i>
                                        <span class="itemLabel fsm">朋友
                                          <span
                                          class="plusLabel hidden_elem fcg">
                                            (+)</span> </span> </a>
                                    </li>
                                    <li id="u3mxyl_25" data-label="自定义"
                                      ...
                                      <a rel="ignore" href="#"
                                        ...
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_853685"></i>
                                        <span class="itemLabel fsm">自定义
                                          <span
                                          class="customPrivacyInputs"></span>
                                      </span> </a>
                                    </li>
                                    <li class="uiMenuSeparator"></li>
                                    <li id="u3mxyl_26" data-label="挚友"
                                      ...
                                      <a
                                        ...
                                        rel="async-post" href="#"
                                        data-flid="2634661952657"
                                        aria-checked="false"
                                        tabindex="-1"
                                        role="menuitemradio"
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_357d0f"></i>
                                        <span class="itemLabel fsm">挚友</span>
                                      </a>
                                    </li>
                                    <li id="u3mxyl_27" data-label="家人"
                                      ...
                                      <a
                                        ...
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_0a8b75"></i>
                                        <span class="itemLabel fsm">家人</span>
                                      </a>
                                    </li>
                                    <li id="u3mxyl_22" data-label="点头之交"
                                      ...
                                      <a
                                        ...
                                        class="itemAnchor itemWithIcon">
                                        <i
                                        class="mrs itemIcon img sp_7gl7wd sx_7f568c"></i>
                                        <span class="itemLabel fsm">点头之交</span>
                                      </a>
                                    </li>
                                    <li
                                      class="uiMenuSeparator secondaryOption">&lt;</li>
                                    <li data-label="Return"
                                      ...
                                      <a rel="ignore" href="#"
                                        ...
                                        role="menuitemradio"
                                        class="itemAnchor">
                                        <span class="itemLabel fsm">Return</span>
                                      </a>
                                    </li>
                                  </ul>
                                </div>
                    ...
                    <li
                      ...
                      <label for="u3mxyl_8" class="submitBtn uiButton uiButtonConfirm">
                        <input type="submit" id="u3mxyl_8" value="发布" onclick="" />
                      </label>
                    </li>
                  </ul>
                  <div>
            ...
            <div class="storyContent">
              <div class="UIImageBlock clearfix">
                <a
                  ...
                  <img alt="" src="<s:property value="user.avatar"/>"
                    class="uiProfilePhoto profilePic uiProfilePhotoLarge img" />
                </a>
                <div
                  ...
                  <div class="mainWrapper">
                    <h6 data-ft='{"type":1}' class="uiStreamMessage">
                      <div data-ft='{"type":2}'
                        class="actorDescription actorName">
                        <a
                          data-hovercard="/profile/profile!viewProfileInfo.jhtml?userid=<s:property value="user.userid"/>"
                          href="/profile/profile!viewProfileInfo.jhtml?userid=<s:property value="user.userid"/>">
                      ...
                      <s:if test="feed.handle=='sns.publish.text'">
                        <span data-ft='{"type":3}' class="messageBody"><s:property
                            value="feed.body" />
                        </span>
                      </s:if>
                      ...
                      <s:if test="feed.handle=='sns.event.create'">
                        <%@ include
                          file="/WEB-INF/jsp/member/feed/eventfeed.jsp"%>
                      </s:if>
...
<script type="text/javascript">
  ...
  function updateStatus(form) {
    var message = form.feedmessage.value;
    var group = form.messagegroup.value;

    $.post("usr/feed!updateStatusAjax.jhtml",{
      feedmessage: message,
      messagegroup: group
    },function(data) {
