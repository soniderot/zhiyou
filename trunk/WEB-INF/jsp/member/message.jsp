										...
										<div class="clearfix uiHeaderTop">
											<div class="uiToolbar uiToolbarUnbordered mlm uiHeaderActions rfloat">
												<div class="clearfix uiToolbarContent">
													<div>
														<a class="uiToolbarItem uiButton" role="button" href="/ajax/messaging/async.php?action=composerDialog" rel="dialog">
														...
														<form class="pls uiToolbarItem" method="get" onsubmit="return function(event){$(&quot;MessagingQuery&quot;).blur();}.call(this,event)!==false &amp;&amp; Event.__inlineSubmit(this,event)" id="MessagingSearch" action="/">
															...
															<div class="uiComboInput MessagingSearchFilter">
																		...
																		<div class="uiSelectorMenuWrapper uiToggleFlyout">
																			<div role="menu" class="uiMenu uiSelectorMenu">
																				<ul class="uiMenuInner">
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption disabled" data-label="搜索：">
																						<a class="itemAnchor" role="menuitemradio" tabindex="0" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">搜索：</span>
																						</a>
																						<span class="itemAnchor disabledAnchor">
																							<span class="itemLabel">搜索：</span>
																						</span>
																					</li>
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption" data-label="未读消息">
																						<a class="itemAnchor" role="menuitemradio" tabindex="-1" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">未读消息</span>
																						</a>
																					</li>
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption" data-label="已存档信息">
																						<a class="itemAnchor" role="menuitemradio" tabindex="-1" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">已存档信息</span>
																						</a>
																					</li>
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption" data-label="已发送信息">
																						<a class="itemAnchor" role="menuitemradio" tabindex="-1" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">已发送信息</span>
																						</a>
																					</li>
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption" data-label="仅适用于邮件">
																						<a class="itemAnchor" role="menuitemradio" tabindex="-1" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">仅适用于邮件</span>
																						</a>
																					</li>
																					<li class="uiMenuItem uiMenuItemRadio uiSelectorOption" data-label="垃圾信息">
																						<a class="itemAnchor" role="menuitemradio" tabindex="-1" aria-checked="false" href="#" rel="ignore">
																							<span class="itemLabel fsm">垃圾信息</span>
																						</a>
																					</li>
																				</ul>
																			</div>
																...
																<div class="uiTypeahead uiClearableTypeahead MessagingSearchTypeahead" id="us2d05_2">
																	<div class="wrap">
																		<label class="clear uiCloseButton" for="us2d05_3">
																			<input type="button" title="删除" onclick="var c = JSCC.get('j4ec8b8805777739021751603').getCore(); c.reset(); c.getElement().focus(); new URI().addQueryData({&quot;sk&quot;:&quot;inbox&quot;}).go();" id="us2d05_3">
																		</label>
																		<input type="hidden" autocomplete="off" class="hiddenInput">
																		<div class="innerWrap">
																			<input type="text" class="inputtext textInput DOMControl_placeholder" name="query" id="MessagingQuery" value="搜索消息" placeholder="搜索消息" autocomplete="off" onfocus="return wait_for_load(this, event, function() {;JSCC.get('j4ec8b8805777739021751603').init([]);;});" spellcheck="false" title="搜索消息">
																		</div>
																	</div>
																</div>
															</div>
														...
														<tr>
																	...
																	<div class="UIImageBlock clearfix pvs">
																		...
																		<div class="right UIImageBlock_Ext">
																			...
																			<span class="timestamp">
																				<abbr title="2011年11月18日18:25" data-date="Fri, 18 Nov 2011 02:25:01 -0800" class="timestamp">星期五</abbr>
																			</span>
																		</div>
															...
															<td class="pls">
																<a class="uiTooltip archiveLink" onmouseout="this.blur();" ajaxify="/ajax/messaging/async.php?action=tag&amp;tag=action%3Aarchived&amp;tids%5B0%5D=id.237791252950736&amp;state=1" href="#" rel="async-post">
																	...
																	<span class="uiTooltipWrap top right righttop">
																		<span class="uiTooltipText">存档</span>
																	</span>
																</a>
															</td>
														</tr>
