     ...
     <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5"  style="margin-top:10px;">
        <tr>
          ...
          <p style="font-size:12px;margin:15px 0;line-height:1.5;">${profile.username}决定参加活动：<a style="color:rgb(0, 102, 170);text-decoration:underline;"  href="${domainname}/event/event!viewEvent.jhtml?eventId=${event.id}">${event.eventname}</a>。</p>
